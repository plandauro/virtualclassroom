<div>
    ...
    <x-table-responsive>
        ...
        {{-- BUSCADOR --}}
        <div class="px-6 py-4">
            <input wire:model="search" class="w-full flex-1 border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" placeholder="Busque el nombre de un estudiante...">
        </div>
