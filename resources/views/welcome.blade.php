                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="flex">
                            <ul class="flex text-sm">
                                <li class="mr-1">
                                    {{-- <i class="fas fa-star text-{{$coruse->rating >= 1 ? 'yellow' : 'gray'}}400"></i> --}}
                                    <i class="fas fa-star text-yellow-400"></i>
                                </li>
                                <li class="mr-1">
                                    {{-- <i class="fas fa-star text-{{$coruse->rating >= 2 ? 'yellow' : 'gray'}}400"></i> --}}
                                    <i class="fas fa-star text-yellow-400"></i>
                                </li>
                                <li class="mr-1">
                                    {{-- <i class="fas fa-star text-{{$coruse->rating >= 3 ? 'yellow' : 'gray'}}400"></i> --}}
                                    <i class="fas fa-star text-yellow-400"></i>
                                </li>
                                <li class="mr-1">
                                    {{-- <i class="fas fa-star text-{{$coruse->rating >= 4 ? 'yellow' : 'gray'}}400"></i> --}}
                                    <i class="fas fa-star text-yellow-400"></i>
                                </li>
                                <li class="mr-1">
                                    {{-- <i class="fas fa-star text-{{$coruse->rating >= 5 ? 'yellow' : 'gray'}}400"></i> --}}
                                    <i class="fas fa-star text-yellow-400"></i>
                                </li>
                            </ul>
